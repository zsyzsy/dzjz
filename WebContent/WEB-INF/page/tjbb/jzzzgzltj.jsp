...
//            表格
	function input(){
 		...
 		var get_where=$("#dwbm").val()+","+rq1+","+rq2+","+$("#zzr").val();
        	 jQuery.post("jzzzgzltjAction!getcasebyperson?get_where="+encodeURI(get_where),function(data){
					console.log(data);
	...
	function getRight(){
		...
		jQuery.post("jzzzgzltjAction!getcasebypersonb?dwbm="+dwbm+"&&dlbm="+$("#dlbm").val()+"&&get_where="+encodeURI(where),function(data){
       	 console.log(data);
       	$("#maingrid2").ligerGrid({
       	 height: '99%',
         width: '99%',
