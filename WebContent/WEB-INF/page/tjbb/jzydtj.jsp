...
<div id="layout1" >
  <div position="left" title="统计列表">
    ...
    <input type="hidden" id="bmbm" />
         <div id="main" style="height:600px;height:530px\0;width:100%;display:none"></div>
                      ...
                      series : [
                          {
                              name:'案件数量',
                              type:'bar',
                              data:xAxisAJSL,itemStyle : { normal: {label : {formatter: ' {c}件',show: true}}}
                          },{
                              name:'卷',
                              type:'bar',
                              data:xAxisJ,itemStyle : { normal: {label : {formatter: ' {c}卷',show: true}}}
                          },{
                              name:'文件',
                              type:'bar',
                              data:xAxisWJ,itemStyle : { normal: {label : {formatter: ' {c}件',show: true}}}
                          },{
                              name:'文件页',
                              type:'bar',
                              data:xAxisWJY,itemStyle : { normal: {label : {formatter: ' {c}页 ',show: true}}}
                          }
                      ]
...
<script type="text/javascript">
    $(function (){
        ...
        var layout = $("#layout1").ligerLayout({ leftWidth: '99%', rightWidth: '100%',
