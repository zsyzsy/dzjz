...
//                              		url:"dwAction!queryList", 
        ...
        function addYh() {
            ...
            $.ligerDialog.open({ title: '新增人员信息', target: $('#add_div'), width: 300,
                buttons: [{ text: '确定', onclick: function (item, dialog) {
                    $("#hidden").val("add");
                    submitForm();
                }, cls: 'l-dialog-btn-highlight'
...
//  			    	 $("#xb").val(cksld.xb);
                     ...
                     $("#hidden").val("update");
                         //弹出窗口
  							 $.ligerDialog.open({ title: '编辑单位', target: $('#add_div'), width: 300,
  	                                buttons: [{ text: '确定', onclick: function (item, dialog) {
  	                                    submitForm();
  	                                }, cls: 'l-dialog-btn-highlight'
  	                                }, { text: '取消', onclick: function (item, dialog) {
...
<div id="queryRyJs"></div>
 <div id="add_div" style="padding:0 10px; display: none;">
        ...
        <p><span style="padding-left: 50px;">姓名：</span><span><s:textfield class="l-text" type="text" id="mc" name="mc"  /></span></p>
        <p><span style="padding-left: 25px;">工作证号：</span><span><s:textfield class="liger-textbox"  type="text" id="gzzh" name="gzzh"  /></span></p>
        <p><span style="padding-left: 32px;">CAID号：</span><span><s:textfield class="l-text" type="text" id="caid" name="caid"  /></span></p>
        <p><span style="padding-left: 25px;">联系电话：</span><span><s:textfield class="l-text" type="text" id="yddhhm" name="yddhhm"  /></span></p>
        <p><span style="padding-left: 25px;">电子邮箱：</span><span><s:textfield class="l-text" type="text" id="dzyj" name="dzyj"  /></span></p>
        <p><span style="padding-left: 50px;">性别：</span><span><s:radio list='#{ 0:"女", 1:"男"}' name="xb" id="xb" value="1"/></span></p>
        <p><span >是否临时人员：</span><span><s:radio list='#{ "N":"否", "Y":"是"}' name="sflsry" id="sflsry" value="'N'"/></span></p>
        <p><span style="padding-left: 25px;" >是否停职：</span><span><s:radio list='#{ "N":"否", "Y":"是"}' name="sftz" id="sftz" value="'N'"/></span></p>
