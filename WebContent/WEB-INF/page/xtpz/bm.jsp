...
<%--         <p><span>部门编码:</span><span><s:textfield class="l-text" type="text" id="bmbm" name="bmbm" maxlength="150" /></span></p> --%>
        ...
        <p class="add_last"><span class="bz">备注:</span><span style="margin-left:29px;"><textarea id="bz" name="bz" cols="100" rows="4" class="l-textarea" style="width: 201px; height: 100px;"></textarea></span></p>
...
//                                		url:"dwAction!queryList", 
                                 ...
                                 onSelect :function(data){
                                	if(tree.getSelected()){
											//$("#dwbm").val(tree.getSelected().data.dwbm);
											console.log(tree.getSelected().data.dwbm);
											//console.log(manager);
											//setParm(name,value)	 	设置ajax参数
											manager.setParm("dwbm",tree.getSelected().data.dwbm);
											manager.reload();
											}
                                     } 
                                 });
					...
					manager = $("#maingrid").ligerGrid({
                        ...
                        columns:[
							{ display: '单位名称', name: 'dwbm.dwmc', width: 250, align: 'left' },
							...
							{ display: '备注', name: 'bz',width: 250, align: 'center' },
                       		...
                       		url:'bmqueryList!queryByMap', tree: {
   	                    columnName: 'dwbm.dwmc',
   	                    idField: 'bmbm',
   	                    parentIDField: 'fbmbm'},
   	                    //	ajax 参数
   	                    parms: {dwbm: tree!= null ? tree.getSelected().data.dwbm : dwbm}
                    });
                ...
                switch (hidden) {
     	           ...
     	           case "addLast":
    					...
    					{  
     			    	 ...
     			    	 if(dwbm.trim(String)==""||fbmbm.trim(String)==""||bmmc.trim(String)==""){
