...
<body style="padding:10px">
  ...
  <div  style="overflow: hidden;height: 30px">
    ...
    <span class="dqjz">当前卷宗:</span><span class="dqjzmc">${ajmc}</span><span id="time1">剩余阅卷时间:</span><span id="time"></span><input id="time_text" type="hidden" value="${yjjssj}" />
  </div>
<div id="layout1">
  <!--左侧-->
  ...
  function  yjfp_fhlb(){
   location.href = '<s:url action="lsajyjAction!input" namespace="/" />';
	...
	function leftTree() {
	  ...
	  jQuery.post("lsajyjAction!queryListleftTreeyj?bmsah="+encodeURI(bmsah)+"&&yjxh="+encodeURI(yjxh),function(data){
...
function GetRTime(){
  ...
  var aa=time_txt2.replace("-","/");//从阅卷查看页面传过来的
